...
module.exports = {"button":"button___3_Ozh","outline":"outline___1_EsF","primary":"primary___zYyzg"};;
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1563722766441");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1563722766630");
          });
      }
    }
...
//# sourceMappingURL=styles.7c76092ea84ad6644a51.hot-update.js.map